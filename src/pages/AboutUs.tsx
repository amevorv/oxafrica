...
const AboutUs: React.FC = () => {
  ...
  const styles: { [k: string]: React.CSSProperties } = {
    page: { fontFamily: 'system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial', color: '#222' },
    container: { maxWidth: 1100, margin: '0 auto', padding: '24px' },
    intro: { marginTop: -20, marginBottom: 20, lineHeight: 1.6, color: '#444' },
    toc: { display: 'flex', gap: 12, flexWrap: 'wrap', marginBottom: 18 },
    tocLink: { background: '#f5f5f5', padding: '8px 12px', borderRadius: 6, cursor: 'pointer', fontSize: 14, color: '#0b4d7a' },
    ...
    heading: { margin: 0, fontSize: 20, color: '#0b4d7a' },
    contentText: { marginTop: 8, color: '#333', lineHeight: 1.6 },
    ctaBar: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 28, paddingTop: 18, borderTop: '1px solid #eee' },
    ctaButton: { background: '#0b79d0', color: '#fff', padding: '10px 14px', borderRadius: 6, textDecoration: 'none' }
  };
    ...
    <div style={styles.page}>
      ...
      <div style={styles.container}>
                ...
                <div style={{ width: 120, textAlign: 'center', color: '#6b6b6b', fontSize: 13 }}>
                  <div style={{ width: 80, height: 80, margin: '0 auto', borderRadius: 8, background: '#f2f6fb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <svg width="36" height="36" viewBox="0 0 24 24" fill="none" aria-hidden>
                      <path d="M3 12h18" stroke="#0b79d0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M6 8l6-4 6 4" stroke="#0b79d0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M6 16l6 4 6-4" stroke="#0b79d0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                </div>
              </section>
        ...
        <div style={styles.ctaBar}>
          ...
          <a href="" style={styles.ctaButton}>Contact Us</a>
        </div>
